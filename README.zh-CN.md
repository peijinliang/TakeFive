...
> 一款本地优先的桌面提醒伴侣。它不催你成为更高效的人，只想在忙碌的间隙提醒你：喝口水、看看远处、活动一下，也别忘了好好吃饭和按时回家。
...
很多提醒工具让你一直管理提醒，而不是照顾生活。TakeFive 想做得更轻：设定一次规则，清楚看到下一次什么时候发生，然后安心做手头的事，不被通知风暴拖走。

### 写在前面：愿你认真工作，也认真生活

TakeFive 的出发点其实很朴素。写代码、做设计、处理表格、赶一份方案，认真做事的人常常一坐就是很久，等回过神来，水凉了，肩颈僵了，窗外也已经黑了。

我们做这个小工具，不是为了再给生活增加一套必须完成的指标，也不想用连续打卡和健康焦虑评判谁更自律。只是希望电脑旁能有一个善意的朋友，替你记得那些容易被忙碌挤掉的小事：让眼睛歇一会儿，站起来走两步，按时吃饭，少熬一次夜。提醒可以延后，也可以跳过；照顾自己不该成为另一种压力。

软件当然不能解决生活里的所有疲惫，但如果它能让一个人今天多喝一杯水、早点合上一次电脑，这件事就有意义。愿每一个使用 TakeFive 的人，都能把事情做好，也把自己照顾好，平平安安，健健康康。

### 为每一个认真工作的人，留一点健康的节奏

| 场景 | 今天就能做到 | 正在探索的方向 |
| --- | --- | --- |
| **给眼睛留个远方** | 创建每 45/60 分钟一次的对齐提醒，轻轻提示你看看远处、放松眼睛。 | 一键启用 20-20-20 规则，以及可选半透明/全屏休息界面。 |
| **久坐拉伸与喝水** | 为喝水、起身、肩颈活动或自定义习惯设置循环提醒，会议或专注时可暂停。 | 内置 30 秒、1 分钟、3 分钟动作卡片。 |
| **该收尾的时候** | 设置一次性的“准备收尾”提醒，给工作日画下边界。 | 睡前倒计时与“今晚早点休息”模式。 |
| **留意今天喝了多少** | 提醒数据完全保存在本机，可先用简单规则设置咖啡因检查点。 | 本地咖啡/茶/能量饮料记录与透明的睡眠影响估算。 |
| **专注，也记得休息** | 组合对齐间隔、安静时段和手动开始的休息会话。 | 在专注结束后建议喝水、起身或闭眼一分钟。 |
| **轻轻察觉疲惫** | 用普通提醒发送“看远处 20 秒”或呼吸提示，轻量、不打扰。 | 可选眼疲劳自我管理卡片，不做医疗诊断。 |
| **回头看看这一周** | 本地保存提醒事件和调度结果，便于理解发生了什么。 | 每周回顾专注时长、晚睡、跳过休息和喝水习惯，不做自律评分。 |
| **一位安静的桌面伙伴** | 常驻托盘、离线运行，主窗口关闭后仍继续工作。 | 离线呼吸练习、白噪音和下班前的温和提示卡。 |

左栏是当前产品基础，右栏是产品方向，不代表这些功能已经全部发布。

## 为什么值得常驻

- **关心，但不催促。** 桌面右下角轻量浮窗不抢焦点，默认 7 秒后收起，并支持完成、延后、跳过和收起；偶尔没有做到，也不需要有负担。
